...
$Faqs = [
   [
     'domanda' => "Come state implementando la recente decisione della Corte di 
     giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?",
...
<head>
    ...
    <main>
        <?php
          foreach($Faqs as $Faq) {
            echo '<h2>'.$Faq['domanda'].'</h2>'.'<br>'. nl2br($Faq['risposta'] .'<br>');
        }
        ?>
    </main>
